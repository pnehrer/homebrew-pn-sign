class PnSign < Formula
    ...
    if OS.mac?
        url "https://github.com/pnehrer/pn-sign/releases/download/#{version}/pn-sign-macos.tar.gz"
        sha256 "11c544eaeacd7d61d24e78de79224106fc9ad449a2fffe2ccf21e3dd866da097"
    elsif OS.linux?
        url "https://github.com/pnehrer/pn-sign/releases/download/#{version}/pn-sign-linux.tar.gz"
